...
public class PokemonController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mRigid = transform.GetChild(1).GetComponent<Rigidbody>();
        InfoPanel = GameObject.Find("PlayerInfoPanel").GetComponent<InfoPanel>();
    ...
    void FixedUpdate() 
    {
        switch (global.status)
        {
            case Global.GameStat.WALK:
                ...
                mRigid.MovePosition(transform.position);
                mRigid.AddForce(Vector3.up * 100 * 2);
            ...
            case Global.GameStat.BATTLE:
                if (global.battle.pokemon == pokemon)
                {
                    ...
                    {
                        // It's pokemon's turn!
                        Debug.Log("Pokemon " + pokemon + " attacks.");
